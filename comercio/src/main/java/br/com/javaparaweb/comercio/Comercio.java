...
public class Comercio {
    ...
    private Produto criarProdutoFilmeHobbit() {
        Categoria categoriaFilmes = new Categoria();
        categoriaFilmes.setDescricao("Filmes");
        categoriaFilmes.setResumo("Categoria de filmes");
    ...
    private Produto criarProdutoLivroPeregrino() {
        ...
        categoriaLivro.setDescricao("Livro");
        categoriaLivro.setResumo("Categoria de livros");
    ...
    private Produto criarProdutoAlimentoMistoQuente() {
        Categoria categoriaAlimento = new Categoria();
        categoriaAlimento.setDescricao("Alimento");
        categoriaAlimento.setResumo("Categoria de Alimentos");
    ...
    private Cliente criarClienteFulano() {
        ...
        Endereco endereco = new Endereco();
        endereco.setRua("Rua dos Fulano, 6");
